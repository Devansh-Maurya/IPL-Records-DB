...
<?php
    ...
    $batting_strike_rate = $_POST['battingstrikerate'];
    ...
    $query_player_personal = "INSERT INTO player_personal ". 
        ...
        "'$birth_place', '$position', '$team', '$match_played')";
    
    $query_player_batting = "INSERT INTO player_batting ".
        "VALUES ('$first_name', '$last_name', ".
        "'$batting_innings', '$batting_not_out', ".
        "'$batting_runs_scored', '$batting_highscore', '$batting_strike_rate',".
    ...
    $query_player_bowling = "INSERT INTO player_bowling ".
        ...
        "'$bowling_ball', '$bowling_runs_given', '$bowling_fifer',".
        "'$bowling_tenfer')";
    ...
    echo 'Birth Place : '.$birth_place.'<br />';
    ...
    echo 'Strike rate : '.$batting_strike_rate.'<br />';
